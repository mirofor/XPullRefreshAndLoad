...
public class PullToRefreshLayout extends RelativeLayout {
    ...
    private void initView(Context context, AttributeSet attrs, int defStyle) {
        ...
        reverseUpAnimation = (RotateAnimation) AnimationUtils.loadAnimation(
                context, R.anim.pullable_reverse_up_anim);
        reverseDownAnimation = (RotateAnimation) AnimationUtils.loadAnimation(
                context, R.anim.pullable_reverse_down_anim);
        refreshingAnimation = (RotateAnimation) AnimationUtils.loadAnimation(
                context, R.anim.pullable_rotating_anim);
        // 添加匀速转动动画
        ...
        defaultRefreshView = inflater.inflate(R.layout.pullable_refresh_head, this,
                false);
        refreshView = defaultRefreshView;
        defaultLoadmoreView = inflater.inflate(R.layout.pullable_load_more, this, false);
                    ...
                    case SUCCEED:
                        ...
                        if (null == customRefreshView) {
                            ...
                            refreshStateImageView
                                    .setBackgroundResource(R.drawable.pullable_refresh_succeed);
                        }
                        break;
                    case FAIL:
                    default:
                        ...
                        if (null == customRefreshView) {
                            ...
                            refreshStateImageView
                                    .setBackgroundResource(R.drawable.pullable_refresh_failed);
                        }
                        break;
                }
                if (pullDownY > 0) {
                ...
                switch (refreshResult) {
                    case SUCCEED:
                        ...
                        if (null == customLoadmoreView) {
                            ...
                            loadStateImageView
                                    .setBackgroundResource(R.drawable.pullable_load_succeed);
                        }
                        break;
                    case FAIL:
                    default:
                        ...
                        if (null == customLoadmoreView) {
                            ...
                            loadStateImageView
                                    .setBackgroundResource(R.drawable.pullable_load_failed);
                        }
                        break;
                }
                if (pullUpY < 0) {
